...
def set_state_mass_conserving(
    ...
    Args:
        ...
        shield: an object implementing get_state, set_state, and get_tracer_metadata.
            Defaults to the Fortran wrapper, but can be overrided for testing purposes.
    """
    metadata = shield.get_tracer_metadata()
    ...
    if pressure in state:
        ...
        old_state = shield.get_state([pressure, *water_variables])
